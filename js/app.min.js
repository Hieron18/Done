...
let slider_about = new Swiper('.meeting__slider', {
	// autoplay: {
	// 	delay: 3000,
	...
	// Arrows
	navigation: {
		nextEl: '.meeting__arrow_right',
		prevEl: '.meeting__arrow_left',
	},
	/*
	breakpoints: {
		320: {
...
let slider_about2 = new Swiper('.docket__content', {
	// autoplay: {
	// 	delay: 3000,
	// 	disableOnInteraction: false,
	// },
	...
	// Arrows
	navigation: {
		nextEl: '.docket__arrow_right',
		prevEl: '.docket__arrow_left',
	},
	breakpoints: {
		320: {
			slidesPerView: 1,
...
let slider_about3 = new Swiper('.event__slider', {
	// autoplay: {
	// 	delay: 3000,
	// 	disableOnInteraction: false,
	// },
	...
	// Arrows
	navigation: {
		nextEl: '.event__arrow_right',
		prevEl: '.event__arrow_left',
	},
	breakpoints: {
		320: {
			slidesPerView: 1,
...
let slider_about4 = new Swiper('.banner__slider', {
	// autoplay: {
	// 	delay: 3000,
	// 	disableOnInteraction: false,
	// },
	...
	// Arrows
	navigation: {
		nextEl: '.banner__arrow_right',
		prevEl: '.banner__arrow_left',
	},
	breakpoints: {
		320: {
			slidesPerView: 1,
...
let slider_about5 = new Swiper('.past__slider', {
	// autoplay: {
	// 	delay: 3000,
	// 	disableOnInteraction: false,
	// },
	...
	// Arrows
	navigation: {
		nextEl: '.past__arrow_right',
		prevEl: '.past__arrow_left',
	},
	breakpoints: {
		320: {
			slidesPerView: 1,
...
let buttonNews = document.querySelector(".calendar__filter");
if(buttonNews){
   buttonNews.addEventListener("click", function (e) {
      let dge = document.querySelector(".doing__setting");
      dge.classList.toggle("_active");
   });
}


let itemkMenu = document.querySelectorAll(".menu__item");
if(itemkMenu){
   for (let index = 0; index < itemkMenu.length; index++) {

      let elem = itemkMenu[index];
      let linkMenu = elem.querySelector(".menu__link");
      if(linkMenu){
         linkMenu.addEventListener("click", function (e) {
            
            let subBlock = elem.querySelector(".sub-menu__block");
            if(subBlock){
               subBlock.classList.toggle("_active");
